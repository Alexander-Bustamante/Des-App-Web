...
// Ejercicio 4: Manipulación de cadenas
    ...
    function manipularCadenas() {
        ...
        let ubicacion = direccion + " " + n_casa;
        // Tu código aquí
        alert("La ubicacion es: "+ ubicacion + "\n" + "El largo de la ubicacion es: " + ubicacion.length + "\n" + "El antepenultimo caracter de la ubicacion es: " + ubicacion[ubicacion.length - 3])
        }